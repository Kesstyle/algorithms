...
package pl.kes.algorithms.book.chapter5.book;

import edu.princeton.cs.algs4.Queue;
import pl.kes.algorithms.book.standard.StdIn;
...
public class TrieSTbook<Value> {
   ...
   /**
    ...
    public static void main(String[] args) {
        ...
        TrieSTbook<Integer> st = new TrieSTbook<Integer>();
